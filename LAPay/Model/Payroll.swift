...
extension Payroll {
    var payrollDetails: [PayrollDetail] {
        return [
            ...
            ("Total earnings for the year \(year ?? "")", total_payments?.dollars),
            ...
            ("Percentage of payment in excess of Base Pay which may include bonuses and other payouts", percent_over_base_pay?.percent),
            ...
            ("Other Pay includes bonuses, adjustments, and lump sum payouts", pay_other_actual?.dollars),
